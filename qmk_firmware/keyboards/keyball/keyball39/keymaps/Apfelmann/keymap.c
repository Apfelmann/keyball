...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT_universal(
    ...
    KC_NO , KC_NO , KC_NO , TD(TD_SLEFT_BRACKET_SRIGHT_BRACKET) , KC_NO ,                            TD(TD_PLUS_MINUS) , S(DE_MINS) , S(KC_0) , S(DE_PLUS) , S(KC_5) ,
    KC_LEFT_SHIFT , KC_NO , KC_NO , TD(TD_LEFT_BRACKET_RIGHT_BRACKET) , KC_NO ,                            TD(TD_COMMA_SEMICOLON) ,TD(TD_DOT_COLON) , TD(TD_LEFT_ANGLE_RIGHT_ANGLE) , TD(TD_SLASH_BACKSLASH) , TD(TD_HASH_TILDE) ,
